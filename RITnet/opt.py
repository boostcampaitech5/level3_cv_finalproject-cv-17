...
def parse_args():
    ...
    # Data input settings
    parser.add_argument('--dataset', type=str, default='/opt/ml/eye_data', help='name of dataset')
    ...
    parser.add_argument('--load', type=str, default='/opt/ml/my_RITnet/logs/info/models/dense_net3.pkl', help='load checkpoint file name')
